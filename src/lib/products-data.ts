...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Inner Upgrade',
    industries: ['appliances'],
    tagline: 'Upgraded internal liner or panel.',
    shortDescription: 'Enhanced interior component for appliances.',
    description:
      'Replacement or upgrade part offering improved thermal or mechanical performance.',
    applications: ['Washing machines', 'Dishwashers'],
    keyProperties: [],
    technicalSpecs: [],
    certifications: ['ISO 9001'],
    downloads: [],

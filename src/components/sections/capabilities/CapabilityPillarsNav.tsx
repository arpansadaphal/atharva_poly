      ...
      {pillars.map((pillar) => {
        ...
        return (
          <a
            key={pillar.id}
            href={`#${pillar.id}`}
            className="group bg-white border border-slate-200 rounded-xl p-6 relative block transition-all duration-250 hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(0,0,0,0.09)] focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 flex flex-col h-full"
          >
            ...
            <p className="text-[13px] text-slate-500 mt-1.5 leading-5 flex-1">
              {pillar.description}
            </p>

  ...
  return (
    <section aria-label="Company Introduction" className="bg-slate-50 overflow-hidden">
      ...
      {/* ────────────────────────────────────────────────────────────────────
          ...
          Stacks ABOVE content on mobile per spec.
          ──────────────────────────────────────────────────────────────── */}
      <div className="lg:hidden w-full aspect-[16/9] relative">
        <Image
          src="/assets/homepage/our-story/mainPhoto.jpg"
          alt="Facility interior — quality control process or machine operator, intimate shot, human presence visible"
          fill
          sizes="100vw"
          className="object-cover object-center"
          priority
          ...
          >
            ...
            <div className="relative w-full aspect-[4/5] rounded-sm overflow-hidden">
              ...
              >
                <Image
                  src="/assets/homepage/our-story/mainPhoto.jpg"
                  alt="Facility interior or quality control process — intimate, human presence"
                  fill
                  sizes="(max-width: 1280px) 40vw, 512px"
                  className="object-cover object-center"
                />
              ...
              >
                <Image
                  src="/assets/homepage/our-story/inset-photo.jpg"
                  alt="Product close-up or quality testing detail"
                  fill
                  sizes="240px"
                  className="object-cover object-center"
                />

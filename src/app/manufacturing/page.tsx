...
// Gallery images – add more images as needed
const galleryImages = [
  { 
  ...
  { 
    src: '/assets/manufacturing/faro-arm.jpg', 
    alt: 'FARO arm coordinate measuring machine in quality lab', 
    category: 'quality' as const 
  },
  { 
    src: '/assets/manufacturing/utility.jpg', 
    alt: 'Utility equipment — chillers and temperature controllers', 
    category: 'machinery' as const 
  },
  { 
    src: '/assets/manufacturing/spm-camera.jpg', 
    alt: 'Automated SPM camera inspection station for quality control', 
    category: 'quality' as const 
  },
  { 
    src: '/assets/manufacturing/caps-products.jpg', 
    alt: 'Product samples — precision caps and enclosures', 
    category: 'production' as const 
  },
  // Add more images for the full gallery
  { 
    src: '/assets/manufacturing/tool-room.jpg', 
    alt: 'Tool room with precision mold making equipment', 
    category: 'facility' as const 
  },
  { 
    src: '/assets/manufacturing/material-handling.jpg', 
    alt: 'Raw material handling and storage area', 
    category: 'production' as const 
  },
  { 
...
export default function ManufacturingPage() {
  return (
    <>
      ...
      />
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-12 -mt-6 relative z-20">
        {/* BreadcrumbNav commented out - uncomment if needed */}
      </div>
  ...
  quality management system.
      ...
      <section className="bg-white section-padding" aria-label="Factory and Product Gallery">
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-12">
          ...
          <ManufacturingGalleryPreview 
            images={galleryImages} 
            maxImages={6} // Shows 6 images in preview
            showLink={true}
            galleryHref="/gallery"
          />
        </div>
